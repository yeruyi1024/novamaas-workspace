...
export function Hero(props: HeroProps) {
  ...
  return (
    <section
      className={cn(
        'maas-hero relative z-10 overflow-hidden px-6 pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-40 lg:pb-28',
        props.className
      )}
    >
      <div
        aria-hidden
        className='maas-hero-atmosphere pointer-events-none absolute inset-0 -z-10'
      />
      ...
      <div className='mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8'>
        ...
        <div className='flex flex-col items-start text-left lg:col-span-6'>
          ...
          >
            ...
            <span>{t('Model as a Service')}</span>
          </div>

          <h1
            className='landing-animate-fade-up text-[clamp(2.5rem,4.8vw,4rem)] leading-[1.15] font-bold tracking-tight'
            style={{ animationDelay: '60ms' }}
          >
            {t('Unified model services.')}
            <br />
            <span className='maas-gradient-text'>
              {t('Amplify AI productivity.')}
            </span>
          </h1>
          <p
          ...
          {/* Compatible application entry points */}
          <div
          ...
          >
            <div className='mb-4 flex flex-col gap-1'>
              ...
              <p className='text-muted-foreground text-xs leading-relaxed'>
                {t('Bring model services into the AI tools you already use.')}
              </p>
            </div>
